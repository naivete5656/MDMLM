...
class OutputTransition(nn.Module):
    def __init__(self, inChans, elu, nll, sig):
...
class VNet(nn.Module):
    ...
    def __init__(self, elu=True, nll=False, sig=True):
        super(VNet, self).__init__()
        self.in_tr = InputTransition(5, elu)
        ...
        self.out_tr = OutputTransition(32, elu, nll, sig)
